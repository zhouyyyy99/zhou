...
class Options(object):
    ...
    def __init__(self):
        ...
        # Dataset
        self.parser.add_argument('--select_rois', type=bool, default=False,
                                 help='If is true, the important top 64 rois will be chosen, and others will be dispached.')
        self.parser.add_argument('--roi_file', type=str, default=r'/home/studio-lab-user/sagemaker-studiolab-notebooks/mydata/important_rois.npz')
        self.parser.add_argument('--augmentation', type=bool, default=False,
                                 help="If augmentation, the augmentation datasets will be chosen.")
        self.parser.add_argument('--fix_dataset', type=bool, default=False,
                                 help="If fix dataset, the train, val and test dataset will be fixed when split the datasets.")
        self.parser.add_argument('--indices_json', type=str, default=r'/home/studio-lab-user/sagemaker-studiolab-notebooks/transformer_code/mdd_selected_data_indices.json',
                                 help="If augmentation, this will be used.")
        self.parser.add_argument('--label_str', type=str, default='mdd', choices={'mdd', 'sex'},
                                 help="Which type of data label should be processed.disease mdd or sex.")
        self.parser.add_argument('--feature_t_test', type=bool, default=False,
                                 help="if apply this step, select feature in train dataset by t_test. default:false")
        self.parser.add_argument('--is_combat', type=bool, default=False,
                                 help="if apply this step, the data is preprocessed by combat. default:true")
        ...
        self.parser.add_argument('--dim_size', type=int, default=None,
                                 help="Difine the minisize dimention of dataset to specified smaller random sample, e.g. for rapid debugging purposes. "
                                      "If in [0,1], it will be interpreted as a proportion of the dataset, "
                                      "otherwise as an integer absolute number of samples")
        self.parser.add_argument('--length_size', type=int, default=None,
                                 help="Difine the minisize length of dataset to specified smaller random sample, e.g. for rapid debugging purposes. "
                                      "If in [0,1], it will be interpreted as a proportion of the dataset, "
                                      "otherwise as an integer absolute number of samples")
        ...
        self.parser.add_argument('--mdd_data_type', type=str, default='tc',
                                 help='choose the type of mdd data type.')
        self.parser.add_argument('--mdd_selected', type=bool, default=False,
                                 help="if apply this step, the data is selected first. default:true")
        self.parser.add_argument('--adhd_data_type', type=str, default='tc',
                                 help='choose the type of adhd data type.')
        self.parser.add_argument('--abide_data_type', type=str, default='tc',
                                 help='choose the type of abide data type.')
        self.parser.add_argument('--hc_data_type', type=str, default='corr',
                                 help='choose the type of hc data type.')

        # ---------- slide window set ----------------
        self.parser.add_argument('--slide_window', type=str, choices={'in_datasets', 'in_model'},
                                 help='if use slide window, set use in datasets or in model.')
        self.parser.add_argument('--slide_window_stride', type=int, default=10,
                                 help='set the slide window stride. default=10.')
        self.parser.add_argument('--slide_window_size', type=int, default=50,
                                 help='set the slide window size. default=60.')
        # --------------------------------------
        ...
        self.parser.add_argument('--num_linear_layer', type=int, default=1,
                                 help='Number of output linear layers')
